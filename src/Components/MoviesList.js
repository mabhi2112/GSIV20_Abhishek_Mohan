...
const MoviesList = () => {
 ...
 useEffect(()=>{
 fetch(`https://api.themoviedb.org/3/list/1?api_key=bb1501228cd5d5feaa44be33a27e126a&language=en-US&page=2`).then(res=>res.json()).then(data=>dispatch({type:'displayList',data:data}))
  },[])
  ...
  //     {
  //       adult: false,
  //       backdrop_path: "/4hPJT531skippmci5BfGrJYGfRv.jpg",
  ...
  //     {
  //       adult: false,
  //       backdrop_path: "/y4VtmfWXaZBgnsaNcrW5hskPLUl.jpg",
  //       genre_ids: [28, 27, 14],
  //       id: 36648,
  //       media_type: "movie",
  //       original_language: "en",
  ...
  //       popularity: 1.416,
  //       poster_path: "/mnDo22GA2WUvyWY9PyhZqxdaejC.jpg",
  ...
  //       popularity: 27.673,
  //       poster_path: "/vulF0iqX5z7AW1pdZ572zwsMRMB.jpg",
  ...
  //       popularity: 15.4,
  //       poster_path: "/bhN6oAvVjwiVEhKssM2yxo3cO8g.jpg",
  ...
  //     {
  //       adult: false,
  //       backdrop_path: "/gBpM4TVL07Qxv7cTaxaFDcSTIAu.jpg",
  //       genre_ids: [28, 53],
  //       id: 8867,
  //       media_type: "movie",
  //       original_language: "en",
  ...
  //       popularity: 11,
  //       poster_path: "/6cdSjq64FbCKUCseJpKAjSmqVgT.jpg",
  ...
  //     {
  //       adult: false,
  //       backdrop_path: "/gdkjHuMPwsdE3mw5dchAeRI1Wl2.jpg",
  //       genre_ids: [35, 14, 878],
  //       id: 10658,
  //       media_type: "movie",
  //       original_language: "en",
  ...
  //       popularity: 10.797,
  //       poster_path: "/jnK6IKeuGBFK4GnlsDELoyJur8h.jpg",
  ...
  return (
    <div className="flex flex-wrap  justify-around border-4">
      {List.map((item) => (
